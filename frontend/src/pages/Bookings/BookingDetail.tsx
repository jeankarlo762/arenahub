        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="font-semibold text-green-700">{formatCurrency(Number(booking.totalPrice))}</p>
            </div>
            <div>
            ...
            {booking.payment ? (
              <div className="flex items-center justify-between bg-gray-50 rounded-lg p-3 text-sm">
                <div>
                  ...
                  <p className="text-gray-500 text-xs">{PAYMENT_METHOD_LABELS[booking.payment.method]}</p>
                </div>
