      ...
      <div className="flex flex-col gap-6 max-w-2xl">
        ...
        <Card>
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-sm font-semibold text-gray-900 mb-1">Como funciona</h2>
        ...
        {/* Slug config */}
        <Card>
          <h2 className="text-base font-semibold text-gray-900 mb-4">Configurar link</h2>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-2">
              <div className="flex-1">
                ...
                />
                <p className="text-xs text-gray-400 mt-1">Apenas letras minúsculas, números e hífen</p>
              </div>
            </div>
        ...
        {slug && publicUrl && (
          <Card>
            <h2 className="text-base font-semibold text-gray-900 mb-4">Link para clientes</h2>

            <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-xl border border-gray-200 mb-4">
              <p className="flex-1 text-sm text-gray-700 font-mono truncate">{publicUrl}</p>
              <button
                onClick={handleCopy}
              ...
              <a
                ...
                className="p-2 rounded-lg text-gray-400 hover:text-orange-600 hover:bg-orange-50 transition-colors shrink-0"
                title="Abrir link"
              >
            ...
            <div className="flex flex-col gap-2 text-sm text-gray-600">
              <p className="font-medium text-gray-700">O cliente poderá:</p>
              <ul className="flex flex-col gap-1 ml-4 list-disc text-gray-500">
