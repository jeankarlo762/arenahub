    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 space-y-8">
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 text-sm text-orange-800">
          Ao criar uma conta ou utilizar o ArenaHub, você declara ter lido, compreendido e aceito integralmente estes Termos de Uso e nossa <Link to="/privacidade" className="underline font-medium">Política de Privacidade</Link>.
        </div>

        <Section title="1. Descrição do serviço">
          <p>
            O <strong>ArenaHub</strong>, desenvolvido pela <strong>MK Sistemas</strong>, é uma plataforma SaaS (Software como Serviço)
          ...
          <p>
            O acesso é fornecido mediante plano de assinatura contratado diretamente com a MK Sistemas. O serviço está disponível
        ...
        <Section title="2. Aceitação dos termos">
          <p>
            Estes Termos regem o uso do ArenaHub por parte dos administradores e operadores de arenas ("Usuários"). O uso continuado da
            plataforma implica aceitação integral destes termos. Caso não concorde, você deve cessar o uso imediatamente e notificar a MK Sistemas.
          </p>
        </Section>

        <Section title="3. Cadastro e responsabilidades do usuário">
          <p>Para utilizar o ArenaHub, o Cliente é responsável por:</p>
          <ul className="list-disc list-inside space-y-1 ml-2 mt-2">
            <li>Fornecer informações verídicas, precisas e atualizadas no cadastro</li>
            <li>Manter a confidencialidade de suas credenciais de acesso</li>
            <li>Notificar a MK Sistemas imediatamente em caso de acesso não autorizado</li>
        ...
        <Section title="4. Uso permitido e vedações">
          <p>É permitido usar o ArenaHub para:</p>
          <ul className="list-disc list-inside space-y-1 ml-2 mt-2">
        ...
        <Section title="5. Plano de assinatura e pagamento">
          <p>
            O uso do ArenaHub está sujeito ao pagamento da mensalidade acordada no momento da contratação.
            O não pagamento em até 30 dias após o vencimento poderá resultar na suspensão temporária ou encerramento do acesso.
            Valores e condições de pagamento são definidos em contrato separado entre o Cliente e a MK Sistemas.
          </p>
        </Section>

        <Section title="6. Disponibilidade e suporte">
          <p>
            A MK Sistemas empreenderá esforços razoáveis para manter o ArenaHub disponível. No entanto, não garantimos
        ...
        <Section title="7. Dados e propriedade">
          <p>
            ...
            são de propriedade do Cliente. A MK Sistemas atua como operadora desses dados, conforme definido na LGPD.
          </p>
          <p>
          ...
          <p>
            <strong>O software e a marca ArenaHub</strong> são de propriedade exclusiva da MK Sistemas.
        ...
        <Section title="8. Confidencialidade">
          <p>
            Ambas as partes comprometem-se a manter em sigilo as informações confidenciais da outra parte. A MK Sistemas
        ...
        <Section title="9. Limitação de responsabilidade">
          <p>
            A MK Sistemas não se responsabiliza por:
          </p>
          <ul className="list-disc list-inside space-y-1 ml-2 mt-2">
          ...
          <p className="mt-2">
            Em qualquer caso, a responsabilidade total da MK Sistemas fica limitada ao valor pago pelo Cliente nos últimos 3 meses de serviço.
          </p>
        </Section>

        <Section title="10. Rescisão">
          <p>
            Qualquer das partes pode encerrar o contrato mediante aviso prévio de 30 dias. A MK Sistemas pode suspender ou
        ...
        <Section title="12. Legislação aplicável e foro">
          ...
          <p>
            Fica eleito o foro da comarca de domicílio da MK Sistemas para resolução de quaisquer litígios decorrentes destes Termos,
        ...
        <Section title="13. Contato">
          <p>
            Para dúvidas sobre estes Termos, entre em contato pelo módulo de Suporte na plataforma ou pelo e-mail <strong>contato@mksistemas.com.br</strong>.
          </p>
        </Section>

        <div className="border-t border-gray-200 pt-6 text-sm text-gray-400 text-center">
          <p>ArenaHub — MK Sistemas</p>
          <p className="mt-1">
