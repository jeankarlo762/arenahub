  ...
  return (
    <div className="flex items-center gap-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-xl px-4 py-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5 text-red-700 dark:text-red-400 text-xs font-semibold uppercase tracking-wide mb-0.5">
          <span>Ocupada agora</span>
        </div>
        <div className="flex items-center gap-3 flex-wrap">
          <div className="flex items-center gap-1 text-sm text-gray-800 dark:text-gray-200 font-medium">
            <User size={13} className="text-gray-500 dark:text-gray-400" />
            <span className="truncate">{booking.customerName}</span>
          </div>
          <div className="flex items-center gap-1 text-sm text-red-600 dark:text-red-400 font-semibold tabular-nums">
            <Clock size={13} />
